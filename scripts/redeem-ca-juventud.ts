...
// Will CA Juventud vs. CA Mineiro end in a draw? → YES won
const conditionId = '0xdb36e31bcd15ab88701a67d073f00dd1ff8040493e190149c679a6c0c36452ca';
...
async function main() {
  ...
  console.log('Market: Will CA Juventud vs. CA Mineiro end in a draw?');
  ...
  console.log('YES (draw) balance:', ethers.utils.formatUnits(balance, 6), 'tokens');
  if (balance.isZero()) {
